...
`documentarian-constraints.md` defines what a documentarian does and doesn't do (no suggestions, no critiques, no recommendations). Paraphrase drift reintroduces evaluative language that breaks the locator/analyzer/reviewer separation.
