...
When this command is invoked, and the `Idea` section is empty, respond with:
```
...
5. **Generate and save research document:**
   - **IMPORTANT**: Save the final research document to the `research/` directory
   - Use a descriptive filename: `research-[topic-kebab-case].md` or `research-[component-name]-[topic].md`
