...
Run comprehensive code reviews using GPT-5.3-Codex and Gemini 3 Pro in parallel, then consolidate findings into a unified report with priority levels and confidence scores.
...
**Codex reviewer**: Use `codex` skill with model `gpt-5.3-codex`, reasoning `xhigh`, sandbox `read-only`, full auto mode.
...
**Header**: Scope, date, reviewers (GPT-5.3-Codex xhigh, Gemini 3 Pro)
...
**Footer**: "Generated by /sdlc:review using GPT-5.3-Codex and Gemini 3 Pro"
